...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    -- forms_locales (forms.id = serial/integer → _parent_id integer ✓)
    ...
    -- forms_emails_locales (forms_emails.id = VARCHAR → _parent_id varchar ✓)
    ...
    -- forms block locale tables (forms_blocks_*.id = VARCHAR → _parent_id varchar ✓)
    CREATE TABLE IF NOT EXISTS "forms_blocks_checkbox_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_country_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_email_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_message_locales" ("id" serial PRIMARY KEY NOT NULL, "message" jsonb, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_number_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_select_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "default_value" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_select_options_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_state_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_text_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "default_value" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    CREATE TABLE IF NOT EXISTS "forms_blocks_textarea_locales" ("id" serial PRIMARY KEY NOT NULL, "label" varchar, "default_value" varchar, "_locale" varchar NOT NULL, "_parent_id" varchar NOT NULL, UNIQUE ("_locale", "_parent_id"));
    ...
    -- search_locales (search.id = serial/integer → _parent_id integer ✓)
